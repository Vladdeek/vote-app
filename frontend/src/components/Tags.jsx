const GrayTag = ({ children }) => {
	return (
		<div className='bg-[#F4F4F4] text-[#212121] font-medium rounded-lg py-2 px-3 inline-flex items-center justify-center w-fit gap-2'>
			{children}
		</div>
	)
}

const GreenTag = ({ children }) => {
	return (
...
const YellowTag = ({ children, wfull }) => {
	return (
		<div
			className={`bg-[#FFFBD0] text-[#564E13] font-medium rounded-lg py-2 px-3 inline-flex items-center justify-center ${
				!wfull ? 'w-fit' : 'w-full'
			}  gap-2`}
		>
			{children}
